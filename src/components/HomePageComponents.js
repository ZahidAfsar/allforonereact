...
export default function HomePageComponents() {
  ...
  <div className="container-fluid pt-48 hidden sm:block justify-center">
    <div className="div pt-12 hidden lg:block">
      <div className="flex">
  ...
  <div className="container-fluid pt-1 hidden sm:block justify-center">
    <div className="div pt-2 hidden lg:block">
      <div className="flex">
        <div className="flex-1 pl-44">
          <Link to={'OddEvenPage'} >
            <button
  ...
  <div class="container-fluid hidden lg:hidden sm:block">
  ...
  <div class="container-fluid hidden lg:hidden sm:block">
  <div className="div flex justify-center pb-5">
  <div className="flex justify-center">
        <Link to={'OddEvenPage'} >
          <button
            type="button"
